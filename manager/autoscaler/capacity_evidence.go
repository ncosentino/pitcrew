...
const (
	...
	deficitHostAdmissionWithheld    = "host-admission-withheld"
	deficitHostAdmissionDegraded    = "host-admission-degraded"
	deficitHostAdmissionUnavailable = "host-admission-unavailable"
