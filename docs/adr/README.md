...
| [ADR-0004](adr-0004-ephemeral-runner-execution-domains.md) | Proposed | Preserve ordinary container workers while adding explicit elevated-container, native disposable-VM, and isolated image-builder execution domains. |
