...
| [ADR-0004](adr-0004-bounded-container-capabilities.md) | Accepted | Permit only bounded service-network, KVM, and shared-memory extensions while preserving socketless disposable workers. |
